...
5. Якщо обрано варіант розподілу "Капітанами", то обираєте капітанів, а потім кожен по черзі набирає собі гравців у команду. Якщо обрано інший варіант розподілу, то бот самостійно поділить гравців на команди.`
