...
<b>Як працює рандом?</b>

Бот написаний на мові програмування JavaScript, в якій є вбудований функціонал генерації випадкового числа у заданому діапазоні. Завдяки цьому функціоналу реалізовано рандомний вибір гравця зі списку гравців.

Бот не запам'ятовує та не використовує минулі розподіли, послідовність чи будь-що інше, що може вплинути на поточний рандомний вибір. Іноді може здаватися, що бот наче бере до уваги минулі розподіли, але це лише так здеється через малу вирібку.
