...
const buttons = Object.freeze({
	...
	REMAIN_CAPTAINS_SELECTION_ORDER_BUTTON: Markup.button.callback('Залишити', REMAIN_CAPTAINS_SELECTION_ORDER), // `1️⃣2️⃣3️⃣`
	RANDOM_CAPTAINS_SELECTION_ORDER_BUTTON: Markup.button.callback('Рандомно', RANDOM_CAPTAINS_SELECTION_ORDER), // `🪨✂️📄`
	...
	RESPLIT_BUTTON: Markup.button.callback(`🔄 ${RESPLIT}`, RESPLIT),
