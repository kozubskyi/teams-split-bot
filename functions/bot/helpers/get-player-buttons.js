...
module.exports = function getPlayerButtons(players, buttonsInString = 2) {
  ...
  if (store.lastChosenPlayer) {
    currentIndex++
    buttons[currentIndex] = [Markup.button.callback('🔙 Відмінити останній вибір', 'cancel_last_chosen_player')]
  }

  currentIndex++
  buttons[currentIndex] = [Markup.button.callback('©️ Обрати інших капітанів', 'change_captains')]
